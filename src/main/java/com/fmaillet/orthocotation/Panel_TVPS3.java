...
public class Panel_TVPS3 extends JPanel {
        ...
        jChgeColor.addColorChangedListener(new ColorChangedListener() {
            ...
            public void colorChanged(Color newColor) {
                    ...
                    if (OrthoCotation.baseValues.patientAge.years != 0) 
                        OrthoCotation.barChartTVPS3.changeColor(newColor);
            }
        });
    ...
    public int getPCTLValue (int column) {
        return tvpsPctlValues[column] ;
    }
    ...
    public void updateResults () {
        ...
        OrthoCotation.barChartTVPS3.updateGraph () ;
    }
    ...
    private void jCheckRangeActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jCheckRangeActionPerformed
        OrthoCotation.barChartTVPS3.changeAspect (jCheckTitre.isSelected(), jCheckSousTitre.isSelected(), jCheckRange.isSelected()) ;
    ...
    private void jScoresUnitActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jScoresUnitActionPerformed
        OrthoCotation.barChartTVPS3.updateVisibleScores();
