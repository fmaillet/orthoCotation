 ...
 * @author Fred
 */
public class TVPS4Norms_JDialog extends javax.swing.JDialog {

    /**
     * Creates new form VB_JDialog
     */
    public TVPS4Norms_JDialog(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        ...
        HTMLTEXT = HTMLTEXT + "<br><br><i>(à suivre...)</i></html>";
        //Texte
